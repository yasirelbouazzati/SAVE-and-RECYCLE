...
<!-- Elemento de audio -->
<audio id="myAudio" src="sonidos/musica.mp3"></audio>
...
<script>
  ...
  <form action="" method="POST">
    <input type="hidden" value="1" name="dropPuntos">
    <div class="cuadrado-estrellas" id="cuadradoEstrellas" style="display: flex; flex-direction: row; align-items: center; justify-content: flex-start; height: 100vh;">
      ...
      <img src="imagenes/gameover.png" alt="Game Over" style="width: 70%; height: auto; margin-top: 100px; margin-right: 200px;" />
        ...
        <a href="niveles.php"><img src="imagenes/exits.png" alt="Game Over" style="width: 15%; height: auto; margin-top: 50px; margin-right: 40%;" /> </a>
     
        <a href="nivel1.php"><img src="imagenes/restart-2.png" alt="Estrellas" style="width:30%; margin-top: 50px; height: auto; margin-right: 500px;" /></a>
    </div>
  </form>


    <!-- Contenido del archivo nivel1.html -->
    <form action="libro2.html" method="POST">
...
<div style="text-align: center;">
  <div style="margin: 0 auto;">
    ...
    <button type="submit" name="next"  onclick="window.location.href='nivel2.php';" style="background: none; border: 0px; margin-top: 20px; margin-left: 400px;">
  ...
  <div id="manzana-container">
    <img src="imagenes/manzana.png" class="manzana" alt="Manzana" id="manzana" />
  ...
  <div id="papel-container">
    <img src="imagenes/papel.png" class="papel" alt="Papel" id="papel" />
  ...
  <div id="lata-container">
    <img src="imagenes/lata.png" class="lata" alt="Lata" id="lata" />
  ...
  <div id="cola-container">
    <img src="imagenes/cola.png" class="cola" alt="Cola" id="cola" />
    <div class="cuadrado-blanco" id="cuadrado-cola">
      <div class="texto-contenedores">
        <img src="imagenes/texto-contenedores.png" style="width: 350px; height: 50px" />
      </div>
      <img src="imagenes/verde.png" class="verde" style="width: 150px; height: 150px" id="verde-cola" onclick="cambiarImagen3()" />
  ...
  <script>
    ...
    document.addEventListener("DOMContentLoaded", function() {
      ...
      const audioAmarillo = new Audio('sonidos/tirar-lata.mp3'); // Ajusta la ruta y el formato según tu archivo de sonido
    ...
    document.addEventListener("DOMContentLoaded", function() {
      ...
      const audioAzul = new Audio('sonidos/tirar-papel.mp3'); // Ajusta la ruta y el formato según tu archivo de sonido
...
style="display: grid; place-items: center; height: 100vh; position: relative;">
    ...
    <a href="nivel1.php" style="margin-left: 25%; margin-top: -220px;">
